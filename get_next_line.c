...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/06 06:49:53 by apadilha          #+#    #+#             */
/*   Updated: 2021/11/26 15:53:49 by apadilha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*split_line(char **buffer_backup)
{
	int		i;
	char	*line;
	char	*temp_free;
...
static int	read_text(int fd, char **buffer, char **buffer_backup)
{
	int		bytes_read;
	char	*temp_free;
